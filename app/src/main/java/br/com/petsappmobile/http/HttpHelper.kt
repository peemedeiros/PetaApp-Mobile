...
import br.com.petsappmobile.model.*
...
class HttpHelper {
    ...
    fun post (json: String): String {
        ...
        //criando url do endpoint no servidor
        val URL = "http://192.168.1.106:8000/api/v1/users/"
    ...
    fun getEmpresas(): List<Empresa>{
        ...
        val URL = "http://192.168.1.106:8000/api/v1/empresas-cadastradas"
